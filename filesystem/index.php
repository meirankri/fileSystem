...
$fs = new FileSystem('C:\\vhost\\localhost\\image', 'image');
...
<input type="hidden" id="base_url" value="<?= $fs->base_uri ?>">
<input type="hidden" id="cur_dir" value="<?= $fs->current_dir_uri ;?>">
...
<div class="breadcrumb" data-folder="<?= $fs->current_dir ?>">
         <span>
            ...
            <ul>
                ...
                <li>
                    <a href="?path=<?= $dir['base_path']; ?>">
                        ...
                        <span class="title"><?= ucfirst($dir['name']); ?></span>
                    </a>
                </li>
            <? }; ?>
